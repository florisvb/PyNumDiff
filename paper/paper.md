...
The original PyNumDiff publication [@vanBreugel2022] established the core method set and optimization framework. This version substantially revises it: the taxonomy was reorganized and corrected; the interface unified around explicit keyword arguments; test coverage expanded; and four capabilities — multidimensional data, irregular sample spacing, missing observations, and circular domains — were added throughout.
...
This paper was drafted with assistance from Claude Sonnet 4.6 (Anthropic), which also provided code review and pull request feedback on several recent contributions; all outputs were reviewed and edited by the authors, who take full responsibility for accuracy.
