...
def evaluate_all_methods_on_all_problems(svg_template, 
    ...
    svg_name = 'tvriterative_comparison_dt_'+str(dt)+'_len_'+str(timeseries_length)+'_noisetype_'+noise_type+'_noiseparam0_'+str(noise_parameters[0])+'_noiseparam1_'+str(noise_parameters[1])+'.svg'
    svg_name = os.path.join(os.path.dirname(svg_template), svg_name)
    #layout.write_svg(svg_name)
    ...
    method_parent_and_methods = [  ['total_variation_regularization', 'iterative_velocity'],]
